	...
	<body class="hiw">
		...
		<div class="container">
			...
			<div class="pull-left sidemenu">
					...
					<h2>Targeted Brands</h2>
					<p>Rental price =  10 - 15% of original selling price</p>
					<p>* depending on the condition of the clothes</p>
			</div>
			<div class="hero-unit pull-right">
				<img src="img/hiw/brands.jpg" alt="targeted"/>
			</div>
